...
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initAdmin", function() { return initAdmin; });
...
function initAdmin(socket) {
  ...
  function list(orders, users) {
    ...
    for (var index = 0; index < orders.length && users.length; index++) {
      var element = orders[index];
      var element2 = users[index];
...
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
 ...
 //importing this liaabry to make post requesy

 //this is use to send notification


 //this will give the hh mm time format
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function () {
    var cake = JSON.parse(btn.dataset.pizza);
    console.log(btn);
    updateCart(cake);
  });
});
...
function updateCart(cake) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', cake).then(function (res) {
    //this will make a post request on update-cart rout and now the compiler will jump on to web.js and calll the update cart controller and get back here with respoce
...
var socket = io();
Object(_admin__WEBPACK_IMPORTED_MODULE_2__["initAdmin"])(socket); //join customer with his o  rder id
...
socket.on('orderUpdated', function (data) {
  var upadatedOrder = _objectSpread({}, order); //copying object by ...


  upadatedOrder.updatedAT = moment__WEBPACK_IMPORTED_MODULE_3___default()().format();
...
__webpack_require__(/*! C:\Users\Harsh\Desktop\laxman\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Harsh\Desktop\laxman\resources\scss\app.scss */"./resources/scss/app.scss");
